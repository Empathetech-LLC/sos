...
if (keystorePropertiesFile.exists()) {
    keystorePropertiesFile.inputStream().use { inputStream -> keystoreProperties.load(inputStream) }
}
...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storeFile = keystoreProperties["storeFile"]?.let { filePath -> file(filePath as String)}
