...
# ar
## Promotional text
كاميرا، ومنارة SOS، وقائمة بحقوقك، كل ذلك في مكان واحد.
...
Es ermöglicht dir, Beweise zu sichern, und informiert dich über deine Rechte im Umgang mit Strafverfolgungs- oder Einwanderungsbehörden.
...
यह आपको साक्ष्य (सबूत) रिकॉर्ड करने की सुविधा देता है, और कानून/आव्रजन (इमिग्रेशन) प्रवर्तन अधिकारियों से निपटने के दौरान आपको आपके अधिकारों के प्रति जागरूक रखता है।
...
証拠を記録することができ、法執行機関や入国管理局と接する際のあなたの権利について情報を提供します。
...
증거를 기록할 수 있게 해주며, 경찰 및 이민 당국과 대면할 때 귀하가 가진 권리를 알려줍니다.
...
Он позволяет вам записывать доказательства и информирует вас о ваших правах при общении с правоохранительными органами или иммиграционной службой.
...
Inakuwezesha kurekodi ushahidi, na kukufahamisha kuhusu haki zako unaposhughulika na wasimamizi wa sheria/uhamiaji.
...
Застосунок дозволяє фіксувати докази та інформує про ваші права під час взаємодії з правоохоронними чи імміграційними органами.
